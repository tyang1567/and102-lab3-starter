    ...
    : RecyclerView.Adapter<BestSellerBooksRecyclerViewAdapter.BookViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: BookViewHolder, position: Int) {
        ...
        // Add an OnClickListener to the "BUY ON AMAZON" button
        holder.mBookButton.setOnClickListener {
            ...
            if (!amazonUrl.isNullOrEmpty()) {
                ...
                it.context.startActivity(browserIntent) // Start activity with the intent
            } else {
                Log.e("BestSellerBooks", "Amazon URL is missing or invalid for book: ${book.title}")
                Toast.makeText(it.context, "No Amazon URL available for this book.", Toast.LENGTH_SHORT).show()
            }
        }
